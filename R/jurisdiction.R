...
#'   materials.}
#'   \item{completed}{The number of FOIA requests where the jurisdiction provided \emph{some}
#'   of the requested materials}
#'   \item{partially_completed}{The number of FOIA requests where the jurisdiction rejected the
#'   request}
